...
public class BinaryTree<T>
{
    ...
    {
        Console.WriteLine(this.Value.ToString().PadLeft(2 * indent + 1, ' '));
        if (this.LeftChild != null) { this.LeftChild.PrintIndentedPreOrder(indent + 1); }
        if (this.RightChild != null) { this.RightChild.PrintIndentedPreOrder(indent + 1); }
    }
